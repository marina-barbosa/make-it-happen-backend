    ...
    public partial class MigracaoInicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Goal = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    AmountRaised = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DonateHistoryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ...
                    PaymentMethod = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ReceiptSent = table.Column<bool>(type: "tinyint(1)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DonateHistories", x => x.DonateHistoryId);
                    table.ForeignKey(
                        name: "FK_DonateHistories_Campaigns_CampaignId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DonateHistories_CampaignId",
                table: "DonateHistories",
                column: "CampaignId");

            migrationBuilder.CreateIndex(
                name: "IX_DonateHistories_UserId",
                table: "DonateHistories",
                column: "UserId");
        }
